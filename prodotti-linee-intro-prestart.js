...
try {
  ...
  const introHtml = [
    '<div class="pli-card">',
    '  <div class="pli-photo"><img src="/images/centro-alveoterapia-hq.webp?v=centro-hq-official-1" alt="Centro di Alveoterapia con diffusori e prodotti della Fabbrica delle Api"></div>',
    '  <div class="pli-copy">',
