...
try {
  ...
  // Rimuove solo eventuali vecchie copie dello stesso runtime prima di reinserirlo.
...
(function(){
  const sectionId = 'prodotti-linee-intro-home';
  const styleId = 'prodotti-linee-intro-style';
  let timer = null;
  ...
  function ensureStyle(){
    ...
    style.textContent = `
      ...
      @media (max-width:760px){
        #prodotti-linee-intro-home{padding:0 12px;margin-bottom:18px;}
        #prodotti-linee-intro-home .pli-card{grid-template-columns:1fr;}
        #prodotti-linee-intro-home .pli-photo,#prodotti-linee-intro-home .pli-photo img{min-height:0;aspect-ratio:16/11;}
        #prodotti-linee-intro-home .pli-copy{padding:18px 17px 20px;}
        #prodotti-linee-intro-home .pli-lead{font-size:15px;}
        #prodotti-linee-intro-home .pli-coupon strong{font-size:16px;}
      }
    `;
  ...
  function ensureIntro(){
    const hero = document.getElementById('alveoterapia-integrata-hero2');
    let section = document.getElementById(sectionId);

    // La Hero Alveoterapia esiste solo nella home: se si entra in una linea,
    // l'introduzione viene rimossa e ricompare tornando alla home.
    if (!hero) {
    ...
    if (!section) {
      ...
      section.innerHTML = `
        <div class="pli-card">
          <div class="pli-photo">
            <img src="/images/intro-prodotti-coupon-api.jpg" alt="Centro di Alveoterapia con diffusori e prodotti della Fabbrica delle Api">
          </div>
          <div class="pli-copy">
