...
@media (min-width: 901px){
  .wrap{transform:none!important;margin-bottom:0!important;}
...
@media (max-width: 640px){
  ...
  console.log('[Miele Artigianale] Hero spacing corrected; category cards kept below hero.');
} catch (error) {
...
try {
  ...
  console.log('[Miele Artigianale] Hero spacing corrected; search and brand unchanged.');
} catch (error) {
