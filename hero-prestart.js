...
try {
  ...
  const newLeftSubtitle = `<p className="text-2xl sm:text-3xl font-extrabold text-amber-700 mt-2">Alveoterapia integrata</p>
                                <div className="mt-4 flex flex-nowrap items-start gap-3 sm:gap-4 ml-8 sm:ml-12 lg:ml-16">
...
try {
  ...
  console.log('[Miele Artigianale] Barra ricerca abbassata e ovali Alveoterapia centrati.');
} catch (error) {
