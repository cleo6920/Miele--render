...
try {
  ...
  const newLeftSubtitle = `<p className="text-2xl sm:text-3xl font-extrabold text-amber-700 mt-2">Alveoterapia integrata</p>
                                <div className="mt-4 flex flex-nowrap items-start gap-3 sm:gap-4 ml-24 sm:ml-32 lg:ml-40">
...
try {
  ...
  console.log('[Miele Artigianale] Tipografia hero ridotta; sottotitolo e alveari alzati.');
} catch (error) {
