...
try {
  ...
  const newLeftSubtitle = `<p className="text-2xl sm:text-3xl font-extrabold text-amber-700 mt-2">Alveoterapia integrata</p>
                                <div className="mt-4 flex flex-nowrap items-start gap-3 sm:gap-4 ml-16 sm:ml-24 lg:ml-28">
...
try {
  ...
  console.log('[Miele Artigianale] Fabbrica centrata geometricamente nel box, sottotitolo a sinistra sopra gli alveari.');
} catch (error) {
